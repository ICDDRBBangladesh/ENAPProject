...
public class rv_MainActivity extends AppCompatActivity {
    ...
    private void prepareMovieData() {
        for(int i=0;i<=100000;i++){
            Movie movie = new Movie(String.valueOf(i) + "- Mad Max: Fury Road", "Action & Adventure", "2015");
            movieList.add(movie);
        }

        /*Registration_DataModel d = new Registration_DataModel();
        String SQL = "Select * from Registration  Where CountryCode='1' and FaciCode='1'";
        List<Registration_DataModel> data = d.SelectAll(this, SQL);

        int count = 1;
        for(Registration_DataModel item : data){
            Movie movie = new Movie(String.valueOf(count), item.getpatName(), item.getDataID());
            movieList.add(movie);
    ...
    public class MoviesAdapter extends RecyclerView.Adapter<MoviesAdapter.MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View itemView = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.rv_movie_list_row, parent, false);
