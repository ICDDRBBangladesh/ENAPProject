   ...
   try
     {
         ...
         if(status.length()==0) {
             C.Save("Update Registration set StatusObj='1',Upload='2',modifyDate='"+ Global.DateTimeNowYMDHMS() +"' where CountryCode='" + COUNTRYCODE + "' and FaciCode='" + FACICODE + "' and DataId='" + DATAID + "'");
