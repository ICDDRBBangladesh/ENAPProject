...
import android.content.Context;
 ...
 public class ObsHisCurPreg_DataModel{
        ...
        public void setprevpreg(String newValue){
         ...
         private String _prevpregdk = "";
     public String getprevpregdk(){
         return _prevpregdk;
     }
     public void setprevpregdk(String newValue){
         _prevpregdk = newValue;
     }
     ...
     private String _prevlivebdk = "";
     public String getprevlivebdk(){
         return _prevlivebdk;
     }
     public void setprevlivebdk(String newValue){
         _prevlivebdk = newValue;
     }
     ...
     private String _prevstillbdk = "";
     public String getprevstillbdk(){
         return _prevstillbdk;
     }
     public void setprevstillbdk(String newValue){
         _prevstillbdk = newValue;
     }
     ...
     private String _prevabdk = "";
     public String getprevabdk(){
         return _prevabdk;
     }
     public void setprevabdk(String newValue){
         _prevabdk = newValue;
     }
     ...
     private String _prevcsecdk = "";
     public String getprevcsecdk(){
         return _prevcsecdk;
     }
     public void setprevcsecdk(String newValue){
         _prevcsecdk = newValue;
     }
     ...
     private String _yrslstbthdk = "";
     public String getyrslstbthdk(){
         return _yrslstbthdk;
     }
     public void setyrslstbthdk(String newValue){
         _yrslstbthdk = newValue;
     }
        ...
        public void setbheartratenum(String newValue){
         ...
         private String _anybcompadma = "";
        public String getanybcompadma(){
              return _anybcompadma;
         }
        public void setanybcompadma(String newValue){
              _anybcompadma = newValue;
         }

     private String _anybcompadmb = "";
     public String getanybcompadmb(){
         return _anybcompadmb;
     }
     public void setanybcompadmb(String newValue){
         _anybcompadmb = newValue;
     }

     private String _anybcompadmc = "";
     public String getanybcompadmc(){
         return _anybcompadmc;
     }
     public void setanybcompadmc(String newValue){
         _anybcompadmc = newValue;
     }

     private String _anybcompadmd = "";
     public String getanybcompadmd(){
         return _anybcompadmd;
     }
     public void setanybcompadmd(String newValue){
         _anybcompadmd = newValue;
     }

     private String _anybcompadme = "";
     public String getanybcompadme(){
         return _anybcompadme;
     }
     public void setanybcompadme(String newValue){
         _anybcompadme = newValue;
     }

     private String _anybcompadmf = "";
     public String getanybcompadmf(){
         return _anybcompadmf;
     }
     public void setanybcompadmf(String newValue){
         _anybcompadmf = newValue;
     }

     private String _anybcompadmg = "";
     public String getanybcompadmg(){
         return _anybcompadmg;
     }
     public void setanybcompadmg(String newValue){
         _anybcompadmg = newValue;
     }

     private String _anybcompadmh = "";
     public String getanybcompadmh(){
         return _anybcompadmh;
     }
     public void setanybcompadmh(String newValue){
         _anybcompadmh = newValue;
     }

     private String _anybcompadmoth = "";
     public String getanybcompadmoth(){
         return _anybcompadmoth;
     }
     public void setanybcompadmoth(String newValue){
         _anybcompadmoth = newValue;
     }
        ...
        public List<ObsHisCurPreg_DataModel> SelectAll(Context context, String SQL)
        {
            ...
            while(!cur.isAfterLast())
            {
                ...
                d._prevpregdk = cur.getString(cur.getColumnIndex("prevpregdk"));

                d._prevliveb = cur.getString(cur.getColumnIndex("prevliveb"));
                d._prevlivebdk = cur.getString(cur.getColumnIndex("prevlivebdk"));

                d._prevstillb = cur.getString(cur.getColumnIndex("prevstillb"));
                d._prevstillbdk = cur.getString(cur.getColumnIndex("prevstillbdk"));

                d._prevab = cur.getString(cur.getColumnIndex("prevab"));
                d._prevabdk = cur.getString(cur.getColumnIndex("prevabdk"));

                d._prevcsec = cur.getString(cur.getColumnIndex("prevcsec"));
                d._prevcsecdk = cur.getString(cur.getColumnIndex("prevcsecdk"));

                d._yrslstbth = cur.getString(cur.getColumnIndex("yrslstbth"));
                d._yrslstbthdk = cur.getString(cur.getColumnIndex("yrslstbthdk"));
                ...
                d._anybcompadma = cur.getString(cur.getColumnIndex("anybcompadma"));
                d._anybcompadmb = cur.getString(cur.getColumnIndex("anybcompadmb"));
                d._anybcompadmc = cur.getString(cur.getColumnIndex("anybcompadmc"));
                d._anybcompadmd = cur.getString(cur.getColumnIndex("anybcompadmd"));
                d._anybcompadme = cur.getString(cur.getColumnIndex("anybcompadme"));
                d._anybcompadmf = cur.getString(cur.getColumnIndex("anybcompadmf"));
                d._anybcompadmg = cur.getString(cur.getColumnIndex("anybcompadmg"));
                d._anybcompadmh = cur.getString(cur.getColumnIndex("anybcompadmh"));
                d._anybcompadmoth = cur.getString(cur.getColumnIndex("anybcompadmoth"));
