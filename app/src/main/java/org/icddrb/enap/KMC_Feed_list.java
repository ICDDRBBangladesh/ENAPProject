...
//Android Manifest Code
 //<activity android:name=".KMC_Feed_list" android:label="KMC_Feed: List" />
...
import Utility.*;
 ...
 public class KMC_Feed_list extends Activity {
 ...
 public void onCreate(Bundle savedInstanceState) {
   ...
   try
     {
         setContentView(R.layout.kmc_feed_list);
             ...
             public boolean onTouch(View v, MotionEvent event) {
                 ...
                 if(event.getAction() == MotionEvent.ACTION_DOWN) {
                     if(event.getRawX() >= (lblHeading.getRight() - lblHeading.getCompoundDrawables()[DRAWABLE_RIGHT].getBounds().width())) {
                         AlertDialog.Builder adb = new AlertDialog.Builder(KMC_Feed_list.this);
                         adb.setTitle("Close");
         ...
         btnAdd.setOnClickListener(new View.OnClickListener() {
             ...
             public void onClick(View view) {
                         ...
                         Intent intent = new Intent(getApplicationContext(), KMC_Feed.class);
     ...
     {
         Connection.MessageBox(KMC_Feed_list.this, e.getMessage());
         return;
     }
 }
           ...
           KMC_Feed_DataModel d = new KMC_Feed_DataModel();
            ...
            //dataAdapter.notifyDataSetChanged();
             ...
             for(KMC_Feed_DataModel item : data){
                 ...
                 map.put("cup", item.getcup());
                 map.put("cuptime", item.getcuptime());
                 map.put("cupwho", item.getcupwho());
                 map.put("cupwhooth", item.getcupwhooth());
                 map.put("cuphowmuch", item.getcuphowmuch());
                 map.put("naso", item.getnaso());
                 map.put("nasotime", item.getnasotime());
                 map.put("nasowho", item.getnasowho());
                 map.put("nasowhooth", item.getnasowhooth());
                 map.put("nasohowmuch", item.getnasohowmuch());
                 map.put("suckbst", item.getsuckbst());
                 map.put("sl", i.toString());
                 i += 1;

                 dataList.add(map);
             }
             dataAdapter = new SimpleAdapter(KMC_Feed_list.this, dataList, R.layout.kmc_feed_list,new String[] {"rowsec"},
 ...
 public class DataListAdapter extends BaseAdapter 
 {
     ...
     public View getView(final int position, View convertView, ViewGroup parent) {
         ...
         if (convertView == null) {
 	        convertView = inflater.inflate(R.layout.kmc_feed_row, null); 
 	        }
         ...
         secListRow.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
               ...
               Intent f1;
               f1 = new Intent(getApplicationContext(), KMC_Feed.class);
