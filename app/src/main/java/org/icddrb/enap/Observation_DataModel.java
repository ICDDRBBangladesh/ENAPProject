...
public class Observation_DataModel{
    ...
    public String SaveUpdateData(Context context)
    {
        ...
        try
        {
            if(C.Existence("Select * from "+ TableName +"  Where CountryCode='"+ _CountryCode +"' and FaciCode='"+ _FaciCode +"' and TableId='"+ _TableId +"' and DataID='"+ _DataID +"' and VarName='"+ _VarName +"' and SL='"+ _SL +"'"))
